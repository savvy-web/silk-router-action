...
* [Collect tests only from unit and integration, never restore stripped env vars](test-layout.md) - Place every test under __test__/unit or __test__/integration, keep __test__/utils free of tests, and never restore the environment variables vitest.setup.ts strips.
